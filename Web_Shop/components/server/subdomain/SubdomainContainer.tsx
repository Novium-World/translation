                    ...
                    <>
                        {data.domains.length > 0 ? (
                            <>
                                <div css={tw`w-full lg:w-8/12 mt-4 lg:mt-0`}>
                                    ...
                                    {data.subdomains.length < 1 ?
                                        <p css={tw`text-center text-sm text-neutral-400 pt-4 pb-4`}>
                                            Hier sind keine Subdomains f&uuml;r diesem Server.
                                        </p>
                                        :
                                ...
                                <div css={tw`w-full lg:w-4/12 lg:pl-4`}>
                                    <TitledGreyBox title={'Subdomain Help'}>
                                        <div css={tw`px-1 py-2`}>
                                            Du kannst f&uuml;r dein Server Subdomains benutzen. Als
                                            beispiel: <code>myserver.example.com</code> oder <code>myserver.example.com:25565</code>
                                        </div>
                                    </TitledGreyBox>
                                </div>
                            </>
                            ...
                            <MessageBox type="info" title="Info">
                                Du bekommst wohl keine Subdomain.
                            </MessageBox>
                        )}
                    </>
                )
